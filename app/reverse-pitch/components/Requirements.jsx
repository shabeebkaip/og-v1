    ...
    <div className='flex flex-col gap-5 box-shadow rounded-[23px]'>
      <div className='grid-cols-8 md:grid '>
        ...
        <div className='flex flex-col justify-center col-span-4 py-6 md:px-14 px-7 md:py-0'>
          <h3 className='text-[#FF8500] xl:text-[50px] lg:text-[40px] text-[30px]  font-medium'>{requirements[0]?.text}</h3>
          <ul className='xl:text-[24px] lg:text-[20px] md:text-[15px] text-[24px] text-[#000000] font-normal list-disc  flex flex-col gap-3'>
            {
      ...
      <div className='grid-cols-10 md:grid '>
        ...
        <div className='col-span-5'>
          <div className='flex flex-col justify-center col-span-5 py-6 md:py-0 md:px-14 px-7 '>
            <h3 className='text-[#FF8500] xl:text-[50px] lg:text-[40px] md:text-[30px] text-[30px] font-medium'>{requirements[1]?.text}</h3>
            <ul className='xl:text-[24px] lg:text-[20px] md:text-[15px] text-[24px] text-[#000000] font-normal list-disc flex flex-col gap-3 pb-10 '>
              {
