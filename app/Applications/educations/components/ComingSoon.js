                                ...
                                item[0] ?
                                    <div className="flex lg:flex-row flex-col justify-center items-center rounded-[23px] md:shadow-lg bg-[#D9D9D9] bg-opacity-10 lg:w-[37%] w-full" id="1">
                                        ...
                                        <div className="flex flex-col p-4 2xl:w-[390px] lg:w-[55%] ">
                                            ...
                                            <button className="text-[20px] 2xl:text-[20px] lg:text-[17px] text-[#4C4C4D] 2xl:w-[208px] 2xl:h-[52px] w-[208px] h-[52px] lg:w-[180px] lg:h-[45px] border rounded-full border-[#FF8500] mt-20 bg-white">Apply now <span className="ml-2">&rarr;</span></button>
                                        </div>
                                    </div> : null}
