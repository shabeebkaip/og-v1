...
const CommunityList = async () => {
    ...
    const communityListResponse = await axios.get(`${baseURL}/community-list`)
    const communityList = communityListResponse.data
    const pageContentResponse = await axios.get(`${baseURL}/page-content?key=home`)
