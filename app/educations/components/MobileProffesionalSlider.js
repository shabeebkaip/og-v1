...
const MobileProffesionalSlider = ({testimonial}) => {
    ...
    return (
        ...
        <div className='container relative flex flex-col justify-center w-full px-6 mx-auto my-10 md:px-0'>
            <div className=" md:text-[50px] text-[#4C4C4D] text-center mt-10 md:leading-[50px] lg:leading-[75px] flex flex-col text-[34px] leading-[44px] font-medium justify-center items-center">
