                                                        ...
                                                        item?.btnLink && item?.btnLink.trim() !== "" ? (
                                                            <a href={item?.btnLink} target='_blank' rel="noopener noreferrer">
                                                                <button
                                                                    ...
                                                                    className="text-[20px] 2xl:text-[20px] lg:text-[17px] text-[#4C4C4D] 2xl:w-[208px] 2xl:h-[52px] w-[208px] h-[52px] lg:w-[180px] lg:h-[45px] border rounded-full border-[#FF8500] mt-20 bg-white">Apply now <span className="ml-2">&rarr;</span>
                                                                </button>
                                                            </a>
                                                        )
                                                            : (
                                                                <button onClick={() => {
                                                                    ...
                                                                    setCourseName({ program_name: item[0]?.heading, program_id: item?._id });
                                                                }}
                                                                    className="text-[20px] 2xl:text-[20px] lg:text-[17px] text-[#4C4C4D] 2xl:w-[208px] 2xl:h-[52px] w-[208px] h-[52px] lg:w-[180px] lg:h-[45px] border rounded-full border-[#FF8500] mt-20 bg-white">Apply now <span className="ml-2">&rarr;</span>
                                                                </button>
                                                            ) :
                                                                ...
                                                                item?.btnLink && item?.btnLink.trim() !== "" ? (
                                                                    <a href={item?.btnLink} target='_blank' rel="noopener noreferrer">
                                                                        <button
                                                                            ...
                                                                            className='text-[#4C4C4D] bg-white px-4 py-2 rounded-full border  border-[#FF8500] text-[20px] 2xl:text-[20px]  lg:text-[17px]  lg:w-[170px] w-auto 2xl:w-auto'>Apply now <span className="ml-2">&rarr;</span>
                                                                        </button>
                                                                    </a>
                                                                )
                                                                    : (
                                                                        <button onClick={() => {
                                                                            setPopup(true)
                                                                            setFormId(item?.form_id);
                                                                            setCourseName({ program_name: item[1]?.heading, program_id: item?._id });
                                                                        }}
                                                                            className='text-[#4C4C4D] bg-white px-4 py-2 rounded-full border  border-[#FF8500] text-[20px] 2xl:text-[20px]  lg:text-[17px]  lg:w-[170px] w-auto 2xl:w-auto'>Apply now <span className="ml-2">&rarr;</span>
                                                                        </button>
                                                                    ) :
                                                            ...
                                                            item?.btnLink && item?.btnLink.trim() !== "" ? (
                                                                <a href={item?.btnLink} target='_blank' rel="noopener noreferrer">
                                                                    <button
                                                                        ...
                                                                        className='text-[#4C4C4D] bg-white px-4 py-2 rounded-full border  border-[#FF8500] text-[20px] w-[210px] h-[59px]  md:hidden sm:block mt-8'>Apply now <span className="ml-2">&rarr;</span>
                                                                    </button>
                                                                </a>
                                                            )
                                                                : (
                                                            ...
                                                            item?.btnLink && item?.btnLink.trim() !== "" ? (
                                                                ...
                                                                : (
                                                                    <button onClick={() => {
                                                                        setPopup(true)
                                                                        setFormId(item?.form_id);
                                                                        setCourseName({ program_name: item[2]?.heading, program_id: item?._id });
                                                                    }}
                                                                        className='text-[#4C4C4D] bg-white px-4 py-2 rounded-full border  border-[#FF8500] text-[20px] w-[210px] h-[59px]  md:hidden sm:block mt-8'>Apply now <span className="ml-2">&rarr;</span>
                                                                    </button>
                                                                ) :
